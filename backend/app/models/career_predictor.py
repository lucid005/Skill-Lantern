...
class CareerPredictor:
    ...
    def _build_skill_career_map(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "python": ["Data Scientist", "Software Engineer", "Data Analyst", "Research Scientist"],
            "java": ["Software Engineer", "Mobile App Developer", "DevOps Engineer"],
            "javascript": ["Web Developer", "Software Engineer", "Mobile App Developer"],
            "typescript": ["Web Developer", "Software Engineer"],
            "sql": ["Data Analyst", "Database Administrator", "Data Scientist", "Financial Analyst"],
            "c++": ["Software Engineer", "Electrical Engineer", "Research Scientist"],
            "c": ["Software Engineer", "Electrical Engineer", "Mechanical Engineer"],
            "r": ["Data Scientist", "Data Analyst", "Research Scientist"],
            "machine learning": ["Data Scientist", "Research Scientist", "Software Engineer"],
            "deep learning": ["Data Scientist", "Research Scientist"],
            "ai": ["Data Scientist", "Research Scientist", "Software Engineer"],
            "cloud computing": ["DevOps Engineer", "Software Engineer"],
            "aws": ["DevOps Engineer", "Software Engineer"],
            "docker": ["DevOps Engineer", "Software Engineer"],
            "kubernetes": ["DevOps Engineer", "Software Engineer"],
            "linux": ["DevOps Engineer", "Network Engineer", "Software Engineer"],
            "networking": ["Network Engineer", "Cybersecurity Analyst"],
            "cybersecurity": ["Cybersecurity Analyst", "Network Engineer"],
            "html": ["Web Developer", "UI/UX Designer"],
            "css": ["Web Developer", "UI/UX Designer"],
            "react": ["Web Developer", "Software Engineer", "Mobile App Developer"],
            "angular": ["Web Developer", "Software Engineer"],
            "vue": ["Web Developer", "Software Engineer"],
            "node": ["Web Developer", "Software Engineer"],
            "express": ["Web Developer", "Software Engineer"],
            "mern": ["Web Developer", "Software Engineer"],
            "mean": ["Web Developer", "Software Engineer"],
            "next": ["Web Developer", "Software Engineer"],
            "django": ["Web Developer", "Software Engineer"],
            "flask": ["Web Developer", "Software Engineer"],
            "spring": ["Software Engineer"],
            "flutter": ["Mobile App Developer", "Software Engineer"],
            "kotlin": ["Mobile App Developer", "Software Engineer"],
            "swift": ["Mobile App Developer", "Software Engineer"],
            "react native": ["Mobile App Developer", "Software Engineer"],
            "database": ["Database Administrator", "Data Analyst", "Software Engineer"],
            "mongodb": ["Web Developer", "Database Administrator", "Software Engineer"],
            "postgresql": ["Database Administrator", "Software Engineer"],
            "mysql": ["Database Administrator", "Software Engineer"],
            "excel": ["Data Analyst", "Financial Analyst", "Business Manager"],
            "tableau": ["Data Analyst", "Data Scientist"],
            "power bi": ["Data Analyst", "Financial Analyst"],
            "git": ["Software Engineer", "DevOps Engineer", "Web Developer"],
            "figma": ["UI/UX Designer", "Web Developer"],
            "photoshop": ["UI/UX Designer"],
            "autocad": ["Civil Engineer", "Mechanical Engineer"],
            "solidworks": ["Mechanical Engineer"],
            "matlab": ["Electrical Engineer", "Research Scientist", "Mechanical Engineer"],
            "testing": ["Quality Assurance Engineer", "Software Engineer"],
            "selenium": ["Quality Assurance Engineer"],
            
            # Soft/Business Skills
            "communication": ["Business Manager", "Project Manager", "Product Manager", "Marketing Specialist"],
            "leadership": ["Project Manager", "Product Manager", "Business Manager"],
            "analytical": ["Data Analyst", "Financial Analyst", "Data Scientist"],
            "problem solving": ["Software Engineer", "Data Scientist", "Business Manager"],
            "critical thinking": ["Data Analyst", "Research Scientist", "IT Consultant"],
            "project management": ["Project Manager", "Product Manager", "Business Manager"],
            "business knowledge": ["Business Manager", "Product Manager", "Marketing Specialist"],
            "presentation": ["Business Manager", "IT Consultant", "Product Manager"],
            "negotiation": ["Marketing Specialist", "Business Manager", "Project Manager"],
            "teamwork": ["Project Manager", "Software Engineer", "Business Manager"],
            "writing": ["IT Consultant", "Product Manager", "Marketing Specialist"],
            
            # Design Skills
            "design": ["UI/UX Designer", "Web Developer"],
            "ui/ux": ["UI/UX Designer", "Web Developer"],
            "creative": ["UI/UX Designer", "Marketing Specialist"],
            
            # Domain Skills
            "finance": ["Financial Analyst", "Business Manager"],
            "accounting": ["Financial Analyst", "Business Manager"],
            "marketing": ["Marketing Specialist", "Business Manager"],
            "digital marketing": ["Marketing Specialist"],
            "sales": ["Marketing Specialist", "Business Manager"],
            "hr": ["HR Manager"],
