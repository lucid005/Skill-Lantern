...
export default function Footer() {
  ...
  return (
    <footer className="bg-neutral-50 border-t pt-20 pb-10 border-neutral-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-neutral-600 mb-6 max-w-sm leading-relaxed">
              AI-powered career recommendation platform helping students and
              professionals discover personalized career paths and achieve their
              goals.
            </p>
